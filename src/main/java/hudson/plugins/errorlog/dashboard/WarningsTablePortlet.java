package hudson.plugins.errorlog.dashboard;

import hudson.Extension;
import hudson.model.Descriptor;
import hudson.plugins.analysis.core.AbstractProjectAction;
import hudson.plugins.analysis.dashboard.AbstractWarningsTablePortlet;
import hudson.plugins.errorlog.ErrorLogsProjectAction;
import hudson.plugins.errorlog.Messages;
...
public class WarningsTablePortlet extends AbstractWarningsTablePortlet {
    ...
    protected Class<? extends AbstractProjectAction<?>> getAction() {
        return ErrorLogsProjectAction.class;
    }
