...
import hudson.plugins.errorlog.ErrorLogsHealthDescriptor;
...
/**
 * Tests the class {@link ErrorLogsHealthDescriptor}.
 *
 * @author Ulli Hafner
 */
public class ErrorLogsHealthDescriptorTest extends AbstractHealthDescriptorTest {
    /**
    ...
    public void verifyNumberOfItems() {
        ...
        ErrorLogsHealthDescriptor healthDescriptor = new ErrorLogsHealthDescriptor(NullHealthDescriptor.NULL_HEALTH_DESCRIPTOR);
    ...
    protected AbstractHealthDescriptor createHealthDescriptor(final HealthDescriptor healthDescriptor) {
        return new ErrorLogsHealthDescriptor(healthDescriptor);
    }
}
